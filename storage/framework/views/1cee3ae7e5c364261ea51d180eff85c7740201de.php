<?php $__env->startSection('title','ฝากประวัติ'); ?>
...
<body>
    ...
    <div class="history">
        ...
        <form action="#">
            ...
            <button class="backBtn" type="button" onclick="window.location.href='<?php echo e(url('/jobs/jobsIndex/')); ?>';">back</button>
        </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('jobs/jobsMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Jobs_IT\resources\views/jobs/history.blade.php ENDPATH**/ ?>